...
image: /public/media/2020-08-09-visualising-raycasts-in-godot/cover.png
---
...
<video width="100%" muted autoplay playsinline loop>
  <source src="{{ '/public/media/2020-08-09-visualising-raycasts-in-godot/raycast-line.mp4' | absolute_url }}" type="video/mp4" />
  Your browser does not support the video tag.
</video>

The node tree for this example looks like this:

![]({{ '/public/media/2020-08-09-visualising-raycasts-in-godot/node-tree.png' | absolute_url }})
